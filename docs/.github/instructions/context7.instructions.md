...
## Fallback: context7 skill

If Context7 MCP tools are **not available** in the current environment, use the `.github/skills/context7` skill instead — it provides equivalent lookup via the Context7 REST API (`scripts/context7.sh search` / `scripts/context7.sh docs`).
